...
import com.tohelpyou.client.activity_fragment.LoginActivity;
import com.tohelpyou.client.activity_fragment.MomentActivity;
import com.tohelpyou.client.activity_fragment.UserActivity;
import com.tohelpyou.client.activity_fragment.UserListActivity;
...
import com.tohelpyou.client.model.Moment;
import com.tohelpyou.client.model.MomentItem;
import com.tohelpyou.client.model.User;
import com.tohelpyou.client.util.HttpRequest;
import com.tohelpyou.client.view.CommentView.OnCommentClickListener;
...
, OnHttpResponseListener, OnDialogButtonClickListener, OnItemClickListener {
	...
	public void bindView(MomentItem data_){
		...
		this.isCurrentUser = ThyApplication.getInstance().isCurrentUser(moment.getUserId());
	...
	private boolean isLoggedIn() {
		boolean isLoggedIn = ThyApplication.getInstance().isLoggedIn();
		if (isLoggedIn == false) {
