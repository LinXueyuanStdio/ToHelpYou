...
package com.tohelpyou.client.model;
...
//			}
	...
	public boolean getIsPraised() {
		return getIsPraised(ThyApplication.getInstance().getCurrentUserId());
	}
	...
	public MomentItem setIsPraised(boolean isPraised) {
		...
		User currentUser = ThyApplication.getInstance().getCurrentUser();
	...
	public boolean getIsCommented() {
		return getIsCommented(ThyApplication.getInstance().getCurrentUserId());
	}
