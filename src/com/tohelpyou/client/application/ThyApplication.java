...
package com.tohelpyou.client.application;
 ...
 * @author Lemon
 */
public class ThyApplication extends BaseApplication {
	private static final String TAG = "APIJSONApplication";

	private static ThyApplication context;
	public static ThyApplication getInstance() {
		return context;
	}
