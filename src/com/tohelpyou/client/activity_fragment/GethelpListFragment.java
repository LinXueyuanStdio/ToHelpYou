...
import com.tohelpyou.client.adapter.GethelpAdapter;
import com.tohelpyou.client.application.ThyApplication;
import com.tohelpyou.client.base.BaseHttpListFragment;
...
import com.tohelpyou.client.view.Kanner;
 ...
 */
public class GethelpListFragment extends BaseHttpListFragment<User, GethelpAdapter>
...
, TopBarMenuCallback, OnDataChangedListener {
	 ...
	 * @return
	 */
	public static GethelpListFragment createInstance() {
		return createInstance(RANGE_USER_FRIEND, ThyApplication.getInstance().getCurrentUserId());
	}
	/**
	 * range = RANGE_USER
	 * @param userId
	 * @return
	 */
	public static GethelpListFragment createInstance(long userId) {
	 ...
	 * @return
	 */
	public static GethelpListFragment createInstance(int range, long id) {
	 ...
	 * @return
	 */
	public static GethelpListFragment createInstance(JSONObject search) {
	 ...
	 * @return
	 */
	public static GethelpListFragment createInstance(int range, long id, JSONObject search) {
		GethelpListFragment fragment = new GethelpListFragment();
	 ...
	 * @return
	 */
	public static GethelpListFragment createInstance(List<Long> idList) {
		GethelpListFragment fragment = new GethelpListFragment();
	...
	public void initView() {//必须调用
		super.initView();
		Kanner kanner = new Kanner(context);
		...
		LayoutParams lParams = new LayoutParams(LayoutParams.MATCH_PARENT, 300);
		kanner.setLayoutParams(lParams);
		lvBaseList.setVerticalScrollBarEnabled(false);
		lvBaseList.addHeaderView(kanner);
	}

	@Override
	public void setList(final List<User> list) {
		setList(new AdapterCallBack<GethelpAdapter>() {

			@Override
			public GethelpAdapter createAdapter() {
				return new GethelpAdapter(context);
			}
