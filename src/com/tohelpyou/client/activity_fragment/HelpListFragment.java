...
import com.tohelpyou.client.adapter.HelpAdapter;
 ...
 */
public class HelpListFragment extends BaseHttpListFragment<User, HelpAdapter>
...
, TopBarMenuCallback, OnDataChangedListener {
	 ...
	 * @return
	 */
	public static HelpListFragment createInstance() {
	 ...
	 * @return
	 */
	public static HelpListFragment createInstance(long userId) {
	 ...
	 * @return
	 */
	public static HelpListFragment createInstance(int range, long id) {
	 ...
	 * @return
	 */
	public static HelpListFragment createInstance(JSONObject search) {
	 ...
	 * @return
	 */
	public static HelpListFragment createInstance(int range, long id, JSONObject search) {
	 ...
	 * @return
	 */
	public static HelpListFragment createInstance(List<Long> idList) {
		HelpListFragment fragment = new HelpListFragment();
