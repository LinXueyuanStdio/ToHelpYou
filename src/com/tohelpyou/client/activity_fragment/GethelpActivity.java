 ...
 */
public class GethelpActivity extends BaseActivity implements OnClickListener, OnBottomDragListener
, OnHttpResponseListener {
	...
	public static Intent createIntent(Context context) {
		return new Intent(context, GethelpActivity.class);
	}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.gethelp_activity, this);
