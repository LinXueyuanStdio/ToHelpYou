...
, OnHttpResponseListener, OnBottomDragListener, TopBarMenuCallback, OnDataChangedListener {
	...
	public void onDataChanged() {
		setUser(ThyApplication.getInstance().getCurrentUser());
	}
	...
	public void initEvent() {//必须调用
		...
		findViewById(R.id.llSettingBill).setOnClickListener(this);
		findViewById(R.id.llSettingWallet).setOnClickListener(this);
		findViewById(R.id.llSettingPosition).setOnClickListener(this);
		
		findViewById(R.id.llSettingHelptime).setOnClickListener(this);
		findViewById(R.id.llSettingFriends).setOnClickListener(this);
		findViewById(R.id.llSettingSocialcircle).setOnClickListener(this);
		
		findViewById(R.id.llSettingFeedback).setOnClickListener(this);
	...
	public void onDialogButtonClick(int requestCode, boolean isPositive) {
		...
		case 0:
			...
			ThyApplication.getInstance().logout();
	...
	public void onClick(View v) {//直接调用不会显示v被点击效果
		...
		default:
			...
			case R.id.llSettingInfo:
				...
				break;
			case R.id.llSettingBill:
				toActivity(WalletActivity.createIntent(context));
				break;
			case R.id.llSettingWallet:
				toActivity(WalletActivity.createIntent(context));
				break;
			case R.id.llSettingPosition:break;
			case R.id.llSettingHelptime:break;
			case R.id.llSettingFriends:
				toActivity(UserListActivity.createIntent(context, ThyApplication.getInstance().getCurrentUserId()));
				break;
			case R.id.llSettingSocialcircle:
				toActivity(MomentListActivity.createIntent(context, ThyApplication.getInstance().getCurrentUserId()));
				break;
			case R.id.llSettingFeedback:break;
