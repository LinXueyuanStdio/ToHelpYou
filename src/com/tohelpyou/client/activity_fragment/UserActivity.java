...
import com.tohelpyou.client.base.BaseActivity;
...
import com.tohelpyou.client.util.MenuUtil;
import com.tohelpyou.client.view.UserView;
...
, OnBottomMenuItemClickListener, OnHttpResponseListener, OnDialogButtonClickListener, OnDataChangedListener {
	...
	private void putUser() {
		...
		user = getUser();
		com.tohelpyou.server.model.User userRequest = new com.tohelpyou.server.model.User(user.getId());
